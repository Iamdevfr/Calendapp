        ...
        <form class="form-group-row" method="post">
          ...
          <div class="inputInHeaderHome">
            <div class="form-group">
              ...
              <input placeholder="Que recherchez vous?" name="activity"class="form-control validate" >
            </div>
              <div class="form-group">
                <i class="fa fa-map-marker prefix fa-5x faInInputs" id="colorI2"></i>
                <input placeholder="Dans quelle ville?" name="city" class="form-control validate">
              </div>
          </div>
            <div class="form-group">
